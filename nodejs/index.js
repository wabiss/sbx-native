...
const UUID           = process.env.UUID           || 'b00242fa-ed7b-4005-b060-c98ab8fa6c86'; // UUID，运行哪吒请修改
...
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'bothaven.tgwy.eu.org';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'eyJhIjoiMDFlMmI2ZWM1MTE3N2ExMjY3MzI2NzBlNTYwNjU0MmMiLCJ0IjoiOWVhZmVjNjMtYWFhMy00Y2YyLWIzZTUtOWU4N2I4NDQxZjU2IiwicyI6Ik5EYzVNamN4TURRdFkyWmhOUzAwT0RRekxXSTBaV1V0TldSa1pUTmlabU13WmpOaiJ9';         // argo固定隧道token或json,留空即使用临时隧道
const ARGO_PORT   = Number(process.env.ARGO_PORT) || 8001;       // argo固定隧道端口
const S5_PORT        = process.env.S5_PORT        || '24273';         // socks5端口，留空不启用
const TUIC_PORT      = process.env.TUIC_PORT      || '';         // tuic端口，留空不启用
const HY2_PORT       = process.env.HY2_PORT       || '24273';         // hy2端口，留空不启用
...
const NAME           = process.env.NAME           || 'bothaven';         // 节点名称
